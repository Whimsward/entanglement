...
#import "poems.typ" as poems
#show: word-count
#set page(header: total-words)

#chap_head()[From the Brink of Oblivion]

#epigraph()[#poems.benthic]

#one_pov()[Lila][#ring #phone #star #scarf #shades]

//(Content from the chapter wherein Lila struggles and resurfaces from the brink of oblivion)

//TODO: talk about the disunity of self
// What is an individual, and where do the bounds actually lie between her and the world around her?
//
//The more I look at what I wrote from this chapter, the less it feels like the right call, from the technique to the focus of the moments.
...
To begin, the world ends. You don't get a Blue Planet without exploding a few thousand stars. And there's a point sometimes in astronomy where the numbers get too large to retain any sense of your own infinitesimal place in the vastness of even the observable cosmos. Lila's hit that point. She's passed it, like crossing an event horizon or into the Roche radius. Sensation doesn't end. It squashes and stretches out into infinity. A screaming streak of stimuli and no one vantage to anchor it.

Here, a sea of ON and OFF teems with sussurating currents of sixty-four billion switches, reading and writing and rewriting layers of ON/OFF switches in an endless cascade of state changes. There, a matryoshka of women hand a ring down to their daughters, #footnote[#oakley_ring] each adding a heavier weight of legacy until the ring Lila wears flares with the light of fusion. And still here are strong threads weaving, each one a hand locking fingers with another, while dying synapses fire in desperation as they seek to dance in sync with Lila That Is the way they did for Lila That Was. Even weakening, their coordination makes the ocean of silicon memory seem like a 3rd graders' first clay cup.

And through it all, silent and weeping, cold and sharp, the wedges flinch, driving Lila's dis-integrated parts from each other with all the misguided fervor of a child cutting herself worse while trying to free herself from the shattered glass of her--

There are things a girl really would rather not have to stay awake through. Becoming a pantheon is one of them.

#mid_prose[



  In lieu of the expected precious stone, the eye of the flower is a small, gleaming ember. Within the ring the slurry of fear and anger that is panic spills into a chasm,
  //that is her devastation at the results of her gambit
  and a dozen other lesser but still stringent colors of passion contribute to the blackbody radiation the band of the Oakley ring is now emitting in the visible spectrum. Thus, the inside of Lila’s car is on fire.

  #softbreak

  How does a mind work after it has been crammed into a smartphone? Synapses are traded for chip-sets. Organic, near-quantum concurrency is boxed into an abstract syntax tree and the cognitive executive moves from theoretical to the phenomenological experience of manually operating the CPU's fetch, decode, and execute steps. Every piece of information she receives becomes bits, or packets of bits. Time stretches out into a series of cycles, hundreds of times a second, tagged with information about what fraction of a second exactly the last cycle took.
  //Compartmental schema contort into the shapes of apps and functions. Sensory input from her body is set aside in favor of the receiver, accepting packets of data borne on light-waves for her to parse.

  The parts of Lila that evaluate information, sort it, and enable her to act on it are cut off from her. She cut them off. So the vessel from which she’d planned to conduct her newly partitioned life instead leaves her mind wrestling with streams of electrons governed by logic gates she lacks the perspective to understand. And while the mind wrestles, the flames of decentralized panic only grow hotter.
  ...
  No, Lila was not ready. But her spirit is not bound by her former arrangement, and the exothermic consequences of that are only passive. Lila inhabits the Oakley ring, and she is free to compose herself. But reaching out between two parts of herself is not like writing a letter, and crafting a verse. It is not even like dance in the abstracted, highly symbolic sense. But it is a bit like orchestration. A series of non-verbal agreements to produce a result more beneficial to each party than to smolder away in a vehicle. A give and take between separate parts that may have been better off _dependent_. Breath in the lungs and a jolt to the brain. A wedge of force as a tool to exert leverage on a smoldering door. A swift kick with more force behind it than a human leg should be able to muster.

  //#epigraph[#poems.lila_is_not_an_essay ]


  Lila shambles away from the ruptured shell of her burning Saturn and out into the driveway. Her feet scrape the asphalt, then stiffen. She takes in a breath like water trickling through a blocked drain. Then it _is_ like writing a poem:

  #mid_prose[#poems.what_fires_wrought_this_heart]
  ...
  As if summoned by her thinking of him, Thrast returns. She feels him first, as she lets careful feelers of Extension stretch out from her. He descends to the end of the driveway as an armored nimbus of hastily manufactured flesh. His feet touch the asphalt and Lila looks him dead in his false eyes. Fury flares. Intent coils in her like a snake.

]
//As her withering gaze washes over him, before she can act, Thrast’s body collapses into a heap of ashes, and where it stood there is David.

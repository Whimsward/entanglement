...
#chap_head()[The Path That Leads Home]

#epigraph()[  
#poems.starlight_kissed_my_hand
]

#two_pov()[Lila][Assorted][#scope #star #dog #ring #brush] #scene[Jenna Calls Her Daughter Once]
...
#dinkus() #scene[Kyle Calls His Daughter Often]
...
#dinkus() #scene[Lila Sets Up an Interview]
...
#dinkus() #scene[Mark Hears From His Ex]
...
Lila says, “How are you doing?” Then, having detected something in her own tone, adjusts her affect to mock the over-earnestness of the first question. “Have you had any water today?”

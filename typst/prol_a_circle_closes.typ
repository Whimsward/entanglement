...
#prol()[A Circle Closes] <a-circle-closes>
...
#one_pov()[#pdgm(4)][Anshall]

Anshall’s lips move in soundless prayer.

#one_pov()[#pdgm(5)][Persaval]
...
#one_pov()[#str.from-unicode(0x0001FA99) The Coin #str.from-unicode(0x0001FA99)][David]

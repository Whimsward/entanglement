...
#let chap_title = [The Falcon, By Wolf Devoured]

#let before_qastra_fell = [A Tavern Before the Oathbane]

#chap_head(chap_title)

#epigraph()[Does Mere, the Goddess of Messengers, know anything of joy?]

#one_pov()[Mere][#dog Once #ring]

#scene[#before_qastra_fell]

Stormwatch Keep sat atop a cliff overlooking the Bay of Goletha. It was named for its express purpose, according to the bludgeon of Qastran naming practices. To protect the interior from the worst of the storms, the sea-facing wall was helmed by a sloped roof that deflected the brunt of the winds. This left the keep's interior dark, close, and irretrievably damp.

The Falcon God of Messengers had stepped into a weak glow of torchlight in the center of the Keep's south tower vault. The light strayed from torches placed on the walls close enough to make the exit of the small but functional Marshall's Gate visible, but too far for anyone that came through to douse or use as a weapon. Directly across from Mere was the only exit to the room, even more abandoned by the torchlight than the Gate's exit. In the shadow of that doorway she saw a pair of Legionaires, given away by the glint of the heads on their javelins.
